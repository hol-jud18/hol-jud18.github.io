...
//
// Loaded after prism.min.js (which bundles prism-core + prism-c), so
// Prism.languages.c is guaranteed to exist at this point. No hooks or
// async grammar loading involved.
(function () {
  if (typeof Prism === 'undefined' || !Prism.languages.c) return;
